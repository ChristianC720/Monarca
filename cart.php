                ...
                <table class="table table-striped table-bordered table-hover ">
                    ...
                    ?>
                        ...
                        <tbody>
                            ...
                            $id = rtrim($id, ", ");
                            echo "<tr><td></td><td>Total</td><td>$ " . $_SESSION['sum'] . "</td><td><a href='success.php' class='btn btn-primary'>Confirm Order</a></td></tr>";
                            ?>
                        </tbody>
                    <?php
                    } else {
                        $_SESSION['sum'] = $sum;
                        echo "<img src='../imgs/emptycart.png' class='fa fa-shopping-cart' height='300px'><br/>";
